...
class GPT(nn.Module):
	def __init__(self,h):
		...
		if getattr(h, 'xsa_layers', None):
			for i in h.xsa_layers:
				if i<h.num_layers:self.blocks[i].attn.use_xsa=True
